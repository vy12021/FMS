...
<!-- +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
    ...
    <script type="text/javascript">
        ...
        var flashvars={
            f:'<%=basePath%>/${resource.uri}${resource.resourceUUID}.${resource.desFmt}',//视频地址
            ...
            t:'2|2',//视频开始前播放swf/图片时的时间，多个用竖线隔开
        ...
        function ckmarqueeadv(){
            return '《甘十九妹》是山东电视台根据美籍华人武侠作家萧逸先生的同名作品改编拍摄的电视连续剧，于1996年出品，为中国大陆早期武侠剧代表作之一。';
        }
    </script>
</head>
