...
public class ValidateService {
    ...
    public String GetValidateCode(HttpServletRequest request, HttpServletResponse response)
        ...
        g.dispose();
        String filePath = Constant.contextPath + Constant.validateCodeImagePath + sRand + ".jpg";
        FileOutputStream fos = new FileOutputStream(filePath);
        ImageIO.write(image, "JPEG", fos);
        //ImageIO.write(image, "JPEG", response.getOutputStream());
        fos.flush();
        fos.close();
        return "/" + Constant.validateCodeImagePath + sRand + ".jpg";
    }
    ...
    public boolean removeImage(String imageName) {
        File imageFile = new File(Constant.contextPath + Constant.validateCodeImagePath + imageName + ".jpg");
        if(imageFile.exists()) {
